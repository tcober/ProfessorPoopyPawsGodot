...
## stepping on Alembic Town's gate mouth fades into the walkable town scene
## (alembic_town.tscn, arriving at its south gate); the meadow marker fades
## into the meadow zone. Locked spots announce in the banner.
