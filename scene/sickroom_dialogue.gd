extends "res://scene/sickroom.gd"

## THE VERDICT — the screenplay for the doctor's office. The room that plays it is
## scene/sickroom.gd, which this extends; sickroom.tscn carries THIS script.
##
## Everything here is the beat: who speaks, in what order, with what held between
## the lines. Anything that builds or dresses the room belongs in the stage file.
